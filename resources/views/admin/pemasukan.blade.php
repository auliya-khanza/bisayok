	...
	<head>
		...
		<body>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">Rekapitulasi Pemasukan</h2>
							</div>
						</div>
					</div>
				</div>
			...
			<br>
				...
				<h1 class="mb-10">Rekap Pemasukan</h1>
				<div class="box-header">
          			<a href="/pemasukan/tambah" class="btn btn-primary" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i> Tambah</a>
          		</div>
				<br/>
				...
				<table class="table table-bordered">
                	...
                	<tr>
						...
						<td>{{ $p->jumlah }}</td>
						<td>
                            <a href="/pemasukan/edit/{{ $p->id }}" class="btn btn-primary" role="button" title="edit"><i class="glyphicon glyphicon-plus"></i>Edit</a>
                            <a href="/pemasukan/hapus/{{ $p->id }}" class="btn btn-primary" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i>Hapus</a>
						</td>
                    </td>    
                </tr> 
                @endforeach
				</table>
                <h1 class="mb-10">Statistik</h1>
				<div class="panel">
