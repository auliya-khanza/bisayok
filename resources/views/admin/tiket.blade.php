	...
	<head>
		...
		<body>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">Rekapitulasi Penjualan Tiket</h2>
							</div>
						</div>
					</div>
				</div>
			...
			<br>
				...
				<h1 class="mb-10">Penjualan Tiket</h1>
				<div class="box-header">
          			<a href="/tiket/tambah" class="btn btn-primary" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i> Tambah</a>
          			</div>
				<br/>
				...
				<table class="table table-bordered">
                	...
                	<tr>
						...
						<td>
                            ...
                            <a href="/tiket/hapus/{{ $p->id }}" class="btn btn-primary" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i>Hapus</a>
						</td>
                    </td>    
                </tr> 
                @endforeach
